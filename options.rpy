...
define gui.about = _p("""
«Ревизор» - замечательная сатирическая комедия Н.В. Гоголя, шедевр классической русской комедиографии, уже почти постора столетия не сходящая с лучших сцен страны и неоднократно экранизированная.

В данном же издании предпринята попытка взглянуть на знакомую многим историю с другой стороны. Читателю предлагается предагается поставить себя на место Ивана Александровича Хлестакова и пройти эту удивительную историю. 


В основе новеллы комедия Николая Васильевича Гоголя «Ревизор».

Дата написания: 1835 г.

Источник: «Интернет Библиотека Алексее Комарова». (https://ilibrary.ru/)


Серия «Русская классика: новый формат»

Оформление и компьютерный дизайн М.А. Меркурьева

Изобразительный материал подготовлен с использованием ПО «Stable Diffusion»

За основу образов пересонажей была взята экранизация коммедии «Ревизор» Владимара Петрова, 1952 г.
...
define config.save_directory = "Revizor-1696726095"
